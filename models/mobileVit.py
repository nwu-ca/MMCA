...
__all__ = ['MobileViT', 'mobile_vit_xx_small', 'mobile_vit_x_small', 'mobile_vit_small']

model_urls = {
    'mobile_vit_xx_small': 'https://docs-assets.developer.apple.com/ml-research/models/cvnets/classification/mobilevit_xxs.pt',
    'mobile_vit_x_small': 'https://docs-assets.developer.apple.com/ml-research/models/cvnets/classification/mobilevit_xs.pt',
    'mobile_vit_small': 'https://docs-assets.developer.apple.com/ml-research/models/cvnets/classification/mobilevit_s.pt',
...
class MobileViTBlock(nn.Module):
    ...
    def __init__(
        self,
        in_channels: int,
        transformer_dim: int, # 输入到transformerEncoder每个token序列的长度
        ffn_dim: int, # MLP第一个全连接层的节点个数
    ...
    def unfolding(self, x: Tensor) -> Tuple[Tensor, Dict]:
        ...
        x = x.transpose(1, 3)
        # [B, P, N, C] -> [BP, N, C]
        x = x.reshape(batch_size * patch_area, num_patches, -1) # BP指的是展开后划分的像素块的个数，N对应token的长度，C就是通道数
